...
①問い合わせ初回返信（基本形）
→ 新規問い合わせ全般。現在のレッスン情報・次回日程を案内。
例文：
「〇〇様、はじめまして。MJスター運営の鈴木と申します。この度はお問い合わせいただき誠にありがとうございます。
現在〔曲名〕を題材にマイケルの基本的な動きを習得するというレッスンを開催しております。
次回は〔日時〕（スタジオワークル原宿）を予定しております。
ちなみに、受けたい講師のご希望等はございますでしょうか？」
...
理由：MJの振り付けは細かく、経験上お子様は飽きてしまわれる傾向がある。
